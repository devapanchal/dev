      ...
      <div className="flex items-center justify-between h-20">
        ...
        <div className="hidden lg:flex space-x-5 items-center">
          ...
          <button
            ...
            className="flex items-center justify-center p-2 rounded-lg bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700"
      ...
      {isOpen && (
        <div className="lg:hidden bg-white/95 dark:bg-gray-900/95 rounded-b-xl shadow-lg">
          <div className="px-4 pt-2 pb-3 space-y-1">
            ...
            <Link
              href="#contact"
              className="flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700"
              onClick={() => setIsOpen(false)}
            >
              Request a Project
